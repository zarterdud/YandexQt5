...
class QtWin(PyQt5.sip.simplewrapper):
    ...
    @typing.overload
    def taskbarActivateTabAlt(
        self, window: typing.Optional[QtWidgets.QWidget]
    ) -> None: ...
    @typing.overload
    def taskbarActivateTab(self, a0: typing.Optional[QtGui.QWindow]) -> None: ...
    @typing.overload
    def taskbarActivateTab(
        self, window: typing.Optional[QtWidgets.QWidget]
    ) -> None: ...
    @typing.overload
    def markFullscreenWindow(
        self, a0: typing.Optional[QtGui.QWindow], fullscreen: bool = ...
    ) -> None: ...
    @typing.overload
    def markFullscreenWindow(
        self, window: typing.Optional[QtWidgets.QWidget], fullscreen: bool = ...
    ) -> None: ...
    ...
    @typing.overload
    def disableBlurBehindWindow(
        self, window: typing.Optional[QtGui.QWindow]
    ) -> None: ...
    @typing.overload
    def disableBlurBehindWindow(
        self, window: typing.Optional[QtWidgets.QWidget]
    ...
    def enableBlurBehindWindow(
        self, window: typing.Optional[QtGui.QWindow], region: QtGui.QRegion
    ) -> None: ...
    @typing.overload
    def enableBlurBehindWindow(
        self, window: typing.Optional[QtGui.QWindow]
    ...
    @typing.overload
    def enableBlurBehindWindow(
        self, window: typing.Optional[QtWidgets.QWidget], region: QtGui.QRegion
    ) -> None: ...
    @typing.overload
    def enableBlurBehindWindow(
        self, window: typing.Optional[QtWidgets.QWidget]
    ...
    @typing.overload
    def extendFrameIntoClientArea(
        self, window: typing.Optional[QtGui.QWindow], margins: QtCore.QMargins
    ) -> None: ...
    @typing.overload
    def extendFrameIntoClientArea(
        self, window: typing.Optional[QtWidgets.QWidget], margins: QtCore.QMargins
    ) -> None: ...
    @typing.overload
    def extendFrameIntoClientArea(
        self,
    ...
    def windowFlip3DPolicy(
        self, a0: typing.Optional[QtGui.QWindow]
    ...
    def setWindowFlip3DPolicy(
        self, window: typing.Optional[QtGui.QWindow], policy: "QtWin.WindowFlip3DPolicy"
    ) -> None: ...
    @typing.overload
    def setWindowFlip3DPolicy(
        self,
        window: typing.Optional[QtWidgets.QWidget],
        policy: "QtWin.WindowFlip3DPolicy",
    ) -> None: ...
    @typing.overload
    def isWindowPeekDisallowed(
        self, window: typing.Optional[QtGui.QWindow]
    ) -> bool: ...
    @typing.overload
    def isWindowPeekDisallowed(
    ...
    def setWindowDisallowPeek(
        self, window: typing.Optional[QtGui.QWindow], disallow: bool
    ) -> None: ...
    @typing.overload
    def setWindowDisallowPeek(
        self, window: typing.Optional[QtWidgets.QWidget], disallow: bool
    ) -> None: ...
    @typing.overload
    def isWindowExcludedFromPeek(
        self, window: typing.Optional[QtGui.QWindow]
    ) -> bool: ...
    @typing.overload
    def isWindowExcludedFromPeek(
    ...
    def setWindowExcludedFromPeek(
        self, window: typing.Optional[QtGui.QWindow], exclude: bool
    ) -> None: ...
    @typing.overload
    def setWindowExcludedFromPeek(
        self, window: typing.Optional[QtWidgets.QWidget], exclude: bool
    ) -> None: ...
    def realColorizationColor(self) -> QtGui.QColor: ...
    def colorizationColor(
        self,
    ) -> typing.Tuple[QtGui.QColor, typing.Optional[bool]]: ...
    ...
    def imageFromHBITMAP(
        self,
        hdc: typing.Optional[PyQt5.sip.voidptr],
        bitmap: typing.Optional[PyQt5.sip.voidptr],
        width: int,
        height: int,
    ) -> QtGui.QImage: ...
...
class QWinJumpList(QtCore.QObject):
    ...
    @typing.overload
    def addCategory(
        self, category: typing.Optional["QWinJumpListCategory"]
    ) -> None: ...
    @typing.overload
    def addCategory(
        self,
        title: typing.Optional[str],
        items: typing.Iterable["QWinJumpListItem"] = ...,
    ) -> typing.Optional["QWinJumpListCategory"]: ...
...
class QWinJumpListCategory(PyQt5.sip.wrapper):
    ...
    def addLink(
        self,
        title: typing.Optional[str],
        executablePath: typing.Optional[str],
        arguments: typing.Iterable[typing.Optional[str]] = ...,
    ) -> typing.Optional["QWinJumpListItem"]: ...
    @typing.overload
    def addLink(
        self,
        icon: QtGui.QIcon,
    ...
    def addDestination(
        self, filePath: typing.Optional[str]
    ) -> typing.Optional["QWinJumpListItem"]: ...
...
class QWinTaskbarButton(QtCore.QObject):
    ...
    def setOverlayAccessibleDescription(
        self, description: typing.Optional[str]
    ) -> None: ...
...
class QWinThumbnailToolBar(QtCore.QObject):
    ...
    def setButtons(
        self, buttons: typing.Iterable["QWinThumbnailToolButton"]
    ) -> None: ...
    def removeButton(
        self, button: typing.Optional["QWinThumbnailToolButton"]
    ) -> None: ...
